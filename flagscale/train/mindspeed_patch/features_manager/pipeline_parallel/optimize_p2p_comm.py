...
from mindspeed_patch.patch_utils import MindSpeedPatchesManager, is_megatron_training_available
...
class OptimizeP2PCommFeature(MindSpeedFeature):
    ...
    def register_patches(self, patch_manager: MindSpeedPatchesManager, args: Namespace):
        ...
        from mindspeed_patch.core.pipeline_parallel.optimize_p2p_comm.adaptor import (
