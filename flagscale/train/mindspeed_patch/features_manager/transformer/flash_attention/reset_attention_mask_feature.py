...
class ResetAttentionMaskFeature(MindSpeedFeature):
    ...
    def register_patches(self, patch_manager, args):
        if getattr(args, self.feature_name, None):
            from mindspeed_patch.core.transformer.flash_attention.reset_attention_mask.adaptor import (
            ...
            from mindspeed_patch.core.transformer.flash_attention.reset_attention_mask.utils import (
                _get_ltor_masks_and_position_ids,
                collate_wrapper,
                get_batch_on_this_cp_rank_wrapper,
            )

            # from mindspeed_patch.core.context_parallel.get_batch_utils import get_batch_on_this_tp_rank
