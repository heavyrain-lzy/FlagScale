...
class DistTrainFeature(MindSpeedFeature):
    ...
    def validate_args(self, args):
        ...
        from mindspeed_patch.core.multi_modal.dist_train.dist_train_config import get_all_config

        if any(cfg.main_dp for cfg in get_all_config().values()):
            from mindspeed_patch.core.multi_modal.dist_train.utils import (
    ...
    def register_patches(self, patch_manager, args):
        if args.dist_train:
            from mindspeed_patch.core.multi_modal import dist_train
