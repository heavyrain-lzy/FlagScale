...
class VirtualOptimizerFeature(MindSpeedFeature):
    ...
    def register_patches(self, patch_manager, args):
        # from mindspeed_patch.core.optimizer.virtual_optimizer.adaptor import virtual_optimizer_step, replace_swap_tensor_wrapper
        if getattr(args, self.feature_name, None):
            # patch_manager.register_patch('mindspeed_patch.optimizer.adamw.AdamW.step', virtual_optimizer_step)
            # patch_manager.register_patch('mindspeed_patch.core.optimizer.adamw.AdamW.step', virtual_optimizer_step)
