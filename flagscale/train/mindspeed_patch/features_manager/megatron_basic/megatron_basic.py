...
class MegatronBasicFeature(MindSpeedFeature):
    ...
    def register_mcore_basic_patches(self, pm, args):
        ...
        from mindspeed_patch.core.megatron_basic.arguments_basic import (
        ...
        from mindspeed_patch.core.megatron_basic.megatron_basic import _set_cuda_rng_state
        ...
        # norm patches
        from mindspeed_patch.core.megatron_basic.megatron_basic import PTNorm
        ...
        from mindspeed_patch.core.distributed.param_and_grad_buffer import (
            finish_grad_sync,
            finish_param_sync,
            start_grad_sync,
            start_param_sync,
        ...
        from mindspeed_patch.core.optimizer.fix_duplicate_allgather import (
        ...
        # avoid async save
        from mindspeed_patch.core.megatron_basic.megatron_basic import preload_tensors
        ...
        from mindspeed_patch.core.megatron_basic.megatron_basic import dist_optim_load_state_dict
    ...
    def register_non_mcore_basic_patches(self, pm, args):
        ...
        # initialization patches
        from mindspeed_patch.core.megatron_basic.megatron_basic import (
        ...
        from mindspeed_patch.core.megatron_basic.megatron_basic import get_device_arch_version
