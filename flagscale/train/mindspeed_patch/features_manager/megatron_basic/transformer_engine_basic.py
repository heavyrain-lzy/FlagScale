...
class TransformerEngineBasicFeature(MindSpeedFeature):
    ...
    def register_patches(self, pm: MindSpeedPatchesManager, args):
        from mindspeed_patch.te.pytorch.module.layernorm_column_parallel_linear import (
        ...
        # from mindspeed_patch.te.pytorch.module.grouped_linear import MindSpeedTEGroupedLinear, MindSpeedTEColumnParallelGroupedLinear, MindSpeedTERowParallelGroupedLinear
