...
class RequirementsBasicFeature(MindSpeedFeature):
    ...
    def te_adaptation(self, pm, args):
        from mindspeed_patch.core.megatron_basic.requirements_basic import (
            dummy_compile,
            version_wrapper,
        )
        from mindspeed_patch.te.pytorch.module.layernorm import MindSpeedTELayernorm
    ...
    def optimizer_selection(self, pm, args):
        from mindspeed_patch.core.optimizer.adamw import AdamW, FusedTorchAdamW
