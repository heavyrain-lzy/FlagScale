...
from mindspeed_patch.core.simple_parallel_cfg import SimpleParallelCfg
from mindspeed_patch.core.tensor_parallel_y_union_cp import TensorParallelYUnionCP
from mindspeed_patch.log_config import log_rank_0
