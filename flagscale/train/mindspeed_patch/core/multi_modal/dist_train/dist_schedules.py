...
from mindspeed_patch.args_utils import get_full_args as get_args
from mindspeed_patch.core.multi_modal.dist_train.dist_communication import (
    generate_send_recv_mask,
    send_recv,
    send_recv_tensor_list,
)
from mindspeed_patch.core.multi_modal.dist_train.dist_ranks_match import get_dst_ranks
from mindspeed_patch.core.multi_modal.dist_train.dist_train_config import (
    get_all_config,
    get_all_config_size,
...
def _backward_step(*args, **kwargs):
    if is_use_multiparam_send_recv():
        from mindspeed_patch.core.pipeline_parallel.multiparameter_schedules import backward_step
