...
# from mindspeed_patch.core.tensor_parallel.tp_2d.group_api_2d import TPYCollectiveComm
# from mindspeed_patch.core.tensor_parallel.tp_2d.layernorm_2d import LayerNorm2D
# from mindspeed_patch.core.tensor_parallel.tp_2d.rms_norm_2d import RMSNorm2D
    ...
    def __new__(cls, config, hidden_size: int, eps: float = 1e-5):
        if config.normalization == "LayerNorm":
            ...
            if getattr(config, "tp_2d", False):
                ...
                from mindspeed_patch.core.fusions.fused_rms_norm import RMSNorm
